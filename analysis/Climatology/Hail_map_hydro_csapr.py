...
DataPath = '/net/k2/storage/people/idariash/home/Field_Campaigns/Relampago/Analisis/EOL/data/csapr'

'/net/k2/storage/people/idariash/home/Field_Campaigns/Relampago/Analisis/EOL/data/chivo_ppi'

'/net/k2/storage/people/idariash/home/Field_Campaigns/Relampago/Analisis/EOL/data/rma/corrected'

'/net/k2/storage/people/idariash/home/Field_Campaigns/Relampago/Analisis/EOL/data/csapr'
...
grid = utl.grid_hail_oneSweep(radar, origin = [-31.6342, -64.1686])
...
chivo_file = '/net/k2/storage/projects/RELAMPAGO/quality_controlled_data/level_1b.2/2018/12/14/chivo.1b.2.20181214_013018.REL_HYDRO360.nc'
topography = Dataset(topo_filename)
radar = pyart.io.read(chivo_file)
grid = utl.grid_hail_oneSweep(radar, origin = [-31.6342, -64.1686])
...
cs = m.scatter(chivo_lons, chivo_lats, accumulated_total_rain, marker = '.', 
               latlon=True,  alpha = 1)
