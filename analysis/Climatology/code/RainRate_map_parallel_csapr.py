...
DataPath = '/top/students/GRAD/ECE/idariash/home/CSU/RELAMPAGO/analysis/Climatology/data/CSAPR'
...
grid = utl.grid_hail_csapr(radar)
...
def get_rain(file):
    try:
        ...
        total_rain_file = (grid.fields['RainRate']['data'].copy())/4 
...
cs = m.pcolormesh(chivo_lons, chivo_lats, accumulated_total_rain, vmin=1, vmax=100 , latlon=True,
        cmap=pyart.graph.cm.LangRainbow12, norm=colors.LogNorm()) # pyart.graph.cm.LangRainbow12 cmocean.cm.rain
