...
chivo_dataPath = '/net/k2/storage/projects/RELAMPAGO/RMA1/drops/20181214'

'/net/k2/storage/people/idariash/home/Field_Campaigns/Relampago/Analisis/EOL/data/20181214/csapr_all'

'/net/k2/storage/projects/RELAMPAGO/quality_controlled_data/level_1b.2/2018/12/14'


'/net/k2/storage/people/idariash/home/Field_Campaigns/Relampago/Analisis/EOL/data/20181214/chivo'
...
def make_figures(file):
    ...
    RainRate_average = chivo_rainRate
    ...
    hail_detection = chivo_HydroClass
    ...
    time_text = time_start.strftime('%Y%m%dT%H%M')
    fig_name = './fig/only_rma_50dBZ/echoTop_hail/radar_retrieval_' + time_text + 'png'
...
pool = mp.Pool(10)
pool.map_async(make_figures, chivo_files)
pool.close()
pool.join()
