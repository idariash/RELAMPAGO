...
clear all
filename = '/top/students/GRAD/ECE/idariash/home/CSU/RELAMPAGO/analysis/Climatology/relampago_statistics_Drops_ppi_rhi.xlsx';
...
ylim([0 20])
xlim([datenum(start_date - 10) datenum(end_date)])
