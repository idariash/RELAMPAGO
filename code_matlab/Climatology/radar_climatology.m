...
clear all
filename = '/net/denali/storage2/radar2/tmp/Ivan/CSU/RELAMPAGO/analysis/Climatology/relampago_statistics_all_Drops.xlsx';
...
for i = start_date:end_date
    ...
    maxRef_day = max_reflectivity(i < time_UTC & time_UTC < i + 1 & index_toFilter);
