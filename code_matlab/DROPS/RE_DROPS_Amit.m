...
input_path = '/net/denali/storage2/radar2/tmp/Ivan/DOE/RELAMPAGO/CSAPR_RHI/';
...
output_path = '/net/denali/storage2/radar2/tmp/Ivan/DOE/RELAMPAGO/DropsAmit/';
...
sounding_file = ' ';
config_file = '/net/denali/storage2/radar2/tmp/Ivan/Utiles/Amit_RE_CSAPR_CHIVO_forCSAPR.v4.ini';
...
%dir([input_path '/*col-radar*.nc']);
    ...
    filename = 'corcsapr2cfrppiM1.a1.20190125.211503.nc';
