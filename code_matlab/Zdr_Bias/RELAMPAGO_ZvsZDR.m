...
DataPath = '/home/idariash/Desktop/Link to Ivan/Field_Campaigns/Relampago/Analisis/Calibration/Data/DROPS/20181126_09to12/';
Directory = dir([DataPath, '*COW*']);
rhoHV_threshold = 0.9;
Z_for_scatter = [];
ZDR_for_scatter = [];
RadarType = 'Vaisala';
...
%    SNR = ncread(filename, 'SNR');
    ...
    Z(RHOHV < 0.95) = nan; %Z(SNR < 10) = nan;
    ZDR(RHOHV < 0.95) = nan;% ZDR(SNR < 10) = nan;
